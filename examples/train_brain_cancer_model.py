"""Example script for training brain cancer classification model."""
...
# Remove BrainCancerClassifier import, as we are only using EffResNetViTClassifier
...
def main():
    ...
    print("=" * 60)
    print("Brain Cancer Classification Model Training (EffResNet-ViT)")
    print("=" * 60)
    
    # Load configuration
    # Use the specific hybrid default for brain cancer
    config = ModelConfig.brain_hybrid_default() # <--- CORRECT CONFIG CALL
    print("\nConfiguration:")
    print(config)   
    ...
    # Note: Requires a successful training run to work correctly
